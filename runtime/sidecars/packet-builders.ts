...
import type { MeetingLayer, PlayerUtteranceType, ProposalSidecarPacket, RiskSidecarPacket } from "./types.ts";
...
function recentTranscriptSlice(roomState: RoomState, maxTurns = 4): ProposalSidecarPacket["recent_transcript"] {
...
export function buildProposalSidecarPacket(roomState: RoomState, playerUtterance: string): ProposalSidecarPacket {
  return {
...
export function buildProposalTargetParticipantIds(roomState: RoomState): string[] {
