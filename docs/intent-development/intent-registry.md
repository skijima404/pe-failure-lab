...
| intent-001 | feature | Platform Engineering Failure Simulation Core Loop | ui-spec |  | docs/intent-development/feature-proposals/fp-intent-001-platform-engineering-failure-simulation-core-loop.md | intent-000 | docs/intent-development/ui-specs/ui-intent-001-simulation-session-flow.md |  | draft | 2026-03-17 |
