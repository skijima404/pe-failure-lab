...
- The learning from project support is not converted into artifacts or service improvements that lower the next user's dependence.
- As a result, the team stays busy enabling while self-service maturity fails to compound.

## Countermove
- Convert recurring enablement effort into assets or service changes that reduce future support need.
- Ask what each round of support leaves behind for the next user.
